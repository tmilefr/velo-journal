...
Si SMTP est configuré dans `.env`, un bandeau **« 🔔 Être prévenu des nouvelles étapes par e-mail »** apparaît en haut du journal **et sur la page de connexion** — l'abonnement n'est pas rattaché au compte (le mot de passe famille est partagé), seule l'adresse e-mail compte :
