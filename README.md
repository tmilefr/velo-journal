...
- **📖 Livre photo** (`/livre`) — une page **A4** (ou carrée 21 × 21 cm) par étape : titre, date, chiffres du jour, récit et collage des photos, façon carnet de voyage. Le tracé du voyage fait la couverture, sur une vraie carte (fond épuré ou tuiles OpenStreetMap), et le profil altimétrique la quatrième. Impression d'un bloc ou export PNG page par page
